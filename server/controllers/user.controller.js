...
const getUserWithHelpOfToken = async (req, res) => {
  try {
...
const getUserWithHelpOfId = async (req, res) => {
  try {
...
module.exports={claimPoints, getAllUser, getMonthlyData, getTodayHistory, getUserHistory, getUserWithHelpOfId, getUserWithHelpOfToken, getWeeklyData}